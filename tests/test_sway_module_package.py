...
def test_sway_wheel_contains_module_and_optional_dependency_only(tmp_path: Path) -> None:
    ...
    assert {
        ...
        "dix/_modules/dix/sway/compositions/groups/models/sway_groups.toml",
        "dix/_modules/dix/sway/apps/groups/app.toml",
        "dix/_modules/dix/sway/apps/navigation_basic/app.toml",
        "dix/_modules/dix/sway/apps/navigation_basic/runtime.py",
        "dix/_modules/dix/sway/apps/navigation_group/app.toml",
        "dix/_modules/dix/sway/apps/navigation_group/runtime.py",
        "dix/_modules/dix/sway/apps/navigation/app.toml",
        "dix/_modules/dix/sway/apps/navigation/runtime.py",
        "dix/_modules/dix/sway/apps/navigation/models/sway_navigation.toml",
